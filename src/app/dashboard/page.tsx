            ...
            {issues.length > 0 ? (
                <div className="w-full border border-gray-600 rounded-2xl mt-8 overflow-hidden">
                    <div className="w-full grid grid-cols-12 border-b border-gray-600 py-2 px-4">
                        ...
                        <div className="hidden md:col-span-3">Created</div>
                    </div>
                    <div className="w-full divide-y divide-gray-900 ">
                        {issues.map((issue) => (
                            ...
                            >
                                <div className=" text-sm md:text-lg col-span-5">{issue.title}</div>
                                <div className="col-span-4 md:col-span-2 text-sm">{issue.status}</div>
                                <div className="col-span-2 text-sm">{issue.priority}</div>
                                <div className="hidden md:col-span-3">{dateConverter(issue.createdAt)}</div>
                            </Link>
                        ))
                        }
                    </div>
